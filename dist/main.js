...
function createInputForTask() {
  ...
  button.addEventListener("click", () => {
    ...
    const selectedProject = _init__WEBPACK_IMPORTED_MODULE_0__.allProjects.find(
      ({ project }) => project === currentProject
    );

    const dateFields = document.querySelector(".date");
    let date = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(dateFields.value), "dd/MM/yyyy");
    ...
    for (let i = 0; i < selectedProject.tasks.length; i++) {
      ...
      doneButton.addEventListener("click", () => {
        ...
        const projectArrayToRemove = _init__WEBPACK_IMPORTED_MODULE_0__.allProjects.find(
          (project) => project === selectedProject
        );

        console.log(_init__WEBPACK_IMPORTED_MODULE_0__.allProjects.indexOf(projectArrayToRemove));
      });

      console.table(selectedProject.tasks[i].task);
    }
  });
  (0,_init__WEBPACK_IMPORTED_MODULE_0__.displayAllProjectNames)();
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ setupDummyProject)
/* harmony export */ });
...
function setupDummyProject(project) {
  const dummyProject = new _projectClass__WEBPACK_IMPORTED_MODULE_0__["default"](project);

  dummyProject.tasks.push(new _toDoClass__WEBPACK_IMPORTED_MODULE_1__["default"]("Task1"));
...
/* harmony export */   displayAllProjectNames: () => (/* binding */ displayAllProjectNames)
/* harmony export */ });
...
/* harmony import */ var _dummyProject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dummyProject */ "./src/dummyProject.js");
/* harmony import */ var _createButtonToAddTask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createButtonToAddTask */ "./src/createButtonToAddTask.js");
...
function displayAllProjectNames() {
  ...
  for (const { project } of allProjects) {
    ...
    newProjButton.addEventListener("click", () => {
      ...
      (0,_createButtonToAddTask__WEBPACK_IMPORTED_MODULE_3__.createButtonToAddTask)();
...
function addProjectButtonFunctionality() {
  ...
  addProjectButton.addEventListener("click", () => {
    ...
    addNewProjectButton.addEventListener("click", () => {
      ...
      const newProject = new _projectClass__WEBPACK_IMPORTED_MODULE_1__["default"](newProjectName);
...
function init() {
  ...
  const dummyProject = (0,_dummyProject__WEBPACK_IMPORTED_MODULE_2__["default"])("dummyProject1");
  const dummyProjectTwo = (0,_dummyProject__WEBPACK_IMPORTED_MODULE_2__["default"])("dummyProject2");
...
class Project {
  ...
  newTask(taskObj, dueDate) {
    const newTask = new _toDoClass__WEBPACK_IMPORTED_MODULE_0__["default"](taskObj, dueDate);
